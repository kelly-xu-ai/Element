...
"use strict";
/* harmony import */ var normalize_wheel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(43);
                  ...
                  fn: function(ref) {
                    ...
                    return [
                      ...
                      _vm.getEditable(item, row, $index)
                        ? _c(
                            _vm.getComponent(item.component),
                            _vm._g(
                              _vm._b(
                                {
                                  tag: "component",
                                ...
                                "component",
                                _vm.getComponentBind(item.component),
                                false
                              ),
                              _vm.getModelEvent({
                                item: item,
...
var mousewheel = __webpack_require__(42);
...
function getEvent(component) {
  if (component && (typeof component === 'undefined' ? 'undefined' : extend_tablevue_type_script_lang_js_typeof(component)) === 'object' && component.event) {
    return component.event;
  }
  return 'input';
}
function getOns(component, params) {
  if (component && component.on && extend_tablevue_type_script_lang_js_typeof(component.on) === 'object') {
    var copy = {};
    Object.keys(component.on).forEach(function (key) {
      copy[key] = function () {
        ...
        (_component$on = component.on)[key].apply(_component$on, [params].concat($event));
      };
    });
    return copy;
  }
...
/* harmony default export */ var extend_tablevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    getComponent: function getComponent() {
      var component = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'el-input';

      if (typeof component === 'string') {
        return component;
      } else if (component && (typeof component === 'undefined' ? 'undefined' : extend_tablevue_type_script_lang_js_typeof(component)) === 'object') {
        return component.name || 'el-input';
      }
      return 'el-input';
    },
    getComponentBind: function getComponentBind(component) {
      if (component && (typeof component === 'undefined' ? 'undefined' : extend_tablevue_type_script_lang_js_typeof(component)) === 'object') {
        var copy = {};
    ...
    getValidateEvents: function getValidateEvents(_ref) {
      var _this = this;
    ...
    getModelEvent: function getModelEvent(_ref2) {
      var _this2 = this,
          _changeEvent;
      ...
      var event = getEvent(item.component);
      ...
      var ons = getOns(item.component, { row: row, prop: item.prop, index: index, oldValue: value });
...
var extend_table_component = Object(componentNormalizer["a" /* default */])(
