...
<el-form ref="form" :model="form" label-width="80px">
  ...
  <el-form-item label="仓库属性">
    <el-select v-model="form.region" placeholder="请选择仓库属性">
...
<el-form :inline="true" :model="formInline" class="demo-form-inline">
  ...
  <el-form-item label="仓库属性">
    <el-select v-model="formInline.region" placeholder="仓库属性">
      <el-option label="区域一" value="shanghai"></el-option>
      <el-option label="区域二" value="beijing"></el-option>
    </el-select>
  </el-form-item>
...
>
  ...
  <el-form-item label="仓库属性" prop="region">
    <el-select v-model="ruleForm.region" placeholder="请选择仓库属性">
      <el-option label="区域一" value="shanghai"></el-option>
      <el-option label="区域二" value="beijing"></el-option>
    </el-select>
  </el-form-item>
  <el-form-item label="保存日期" required>
    <el-col :span="24">
    ...
    data() {
      return {
        ...
        rules: {
          ...
          region: [
            { required: true, message: '请选择仓库属性', trigger: 'change' }
          ],
          date1: [
            {
              type: 'array',
...
<el-form ref="form" :model="sizeForm" label-width="80px" size="mini">
  ...
  <el-form-item label="仓库属性">
    <el-select v-model="sizeForm.region" placeholder="请选择仓库属性">
      <el-option label="区域一" value="shanghai"></el-option>
      <el-option label="区域二" value="beijing"></el-option>
    </el-select>
  </el-form-item>
  ...
  <el-form-item label="检测项目">
    <el-checkbox-group v-model="sizeForm.type">
      ...
      <el-checkbox-button
        ...
        name="type"
      ></el-checkbox-button>
      <el-checkbox-button label="用户资料检测" name="type"></el-checkbox-button>
    </el-checkbox-group>
  </el-form-item>
  <el-form-item label="状态">
