      ...
      <ul class="container">
        <li>
          <div class="card">
            ...
            <h3><%= 3 ></h3>
            <p><%= 4 ></p>
            <router-link active-class="active" to="/<%= lang >/guide/design" exact><%= 5 ></router-link>
          </div>
        </li>
        <li>
          <div class="card">
            ...
            <h3><%= 6 ></h3>
            <p><%= 7 ></p>
            <router-link active-class="active" to="/<%= lang >/component/layout" exact><%= 5 ></router-link>
          </div>
        </li>
        <li>
          <div class="card">
            ...
            <h3><%= 10 ></h3>
            <p><%= 11 ></p>
            <router-link active-class="active" to="/<%= lang >/theme" exact><%= 5 ></router-link>
          </div>
        </li>
        <li>
          <div class="card">
            ...
            <h3><%= 8 ></h3>
            <p><%= 9 ></p>
            <router-link active-class="active" to="/<%= lang >/resource" exact><%= 5 ></router-link>
          </div>
        </li>
      </ul>
    </div>
